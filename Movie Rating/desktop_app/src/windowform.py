...
# label3 = Label(root, text="", font=("bold", 10)).place(x=250, y=350)


display =Label(root, text='00:00', width=20)
display.pack()

# button = Button(root, text='Timer',bg="orange",fg="white", command=toggle)
